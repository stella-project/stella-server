...
def main():
    ...
    rankers = ['dummy_rank', 'dummy_rank_base']
    recommenders = ['gesis_rec_precom', 'gesis_rec_micro']
    ...
    for s in range(0, NUM_SESSION):
        ...
        for f in range(0, NUM_FEEDBACK):
            ...
            r = req.post(API + '/feedbacks/' + str(feedback_id) + '/recommendations', data=payload, auth=(token, ''))
            print(r.text)
